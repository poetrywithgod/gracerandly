// Same structure as apps/requester/src/components/AuthHeader.tsx (see
// GlassCard.tsx's header comment for why it's duplicated) — the only
// difference is the wordmark, so it's obvious at a glance which app is
// running when someone's using both side by side.
